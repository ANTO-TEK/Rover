 ...
 * @brief Header file for the B2B communication protocol (SecondaryBoard side), providing definitions and functions for managing the communication between SecondaryBoard and PrimaryBoard.
 * @version 1.0
 * @date 2024-02-15
 * 
...
/**
 * @brief Processes the received state to compute the next state transition.
 * 
 * Based on the current and received state information, this function computes the next action or state transition that should be taken.
 * 
 */
void b2b_processing_state();

/**
 * @brief Updates the global state of the system based on the computed actions or state transitions.
 * 
 * Applies the changes computed by b2b_processing_state() to the global state of the system. This may involve updating state variables,
 * sending commands to other components, or adjusting operational parameters based on the new state.
 */
