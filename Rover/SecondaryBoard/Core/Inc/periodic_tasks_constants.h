...
#ifndef INC_PERIODIC_TASKS_CONSTANTS_H_
#define INC_PERIODIC_TASKS_CONSTANTS_H_

#define READ_SENSORS_TASK_PHASE 		pdMS_TO_TICKS(0)
#define READ_SENSORS_TASK_PERIOD		pdMS_TO_TICKS(60)
#define READ_SENSORS_TASK_WCET 		    pdMS_TO_TICKS(1)
...
#define ACTUATION_TASK_WCET 			pdMS_TO_TICKS(1)
#define ACTUATION_TASK_DEADLINE			pdMS_TO_TICKS(60)

#endif /* INC_PERIODIC_TASKS_CONSTANTS_H_ */
